...
const WeatherForecast: React.FC<WeatherForecastProps> = ({ forecast }) => {
  return (
    <div className="bg-gray-800 rounded-xl shadow-lg p-5 mb-6">
      ...
      <div className={forecast.length > 1 ? "flex gap-3 overflow-x-auto pb-3 custom-scrollbar" : "flex justify-center"}>
        {forecast.map((day) => (
          <div key={day.date} className="bg-gray-700/50 p-3 rounded-lg flex flex-col text-center items-center justify-between flex-shrink-0 w-36">
            <div>
